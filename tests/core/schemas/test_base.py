...
class TestBaseMetadata:
    ...
    def test_base_metadata_is_abstract(self):
        ...
        with pytest.raises(TypeError):
            BaseMetadata()  # Should raise TypeError for abstract class
    ...
    def test_concrete_implementation_required_properties(self):
        ...
        with pytest.raises(TypeError):
            IncompleteMetadata()  # Should fail due to missing abstract methods
    ...
    def test_complete_implementation(self):
        ...
        class CompleteMetadata(BaseMetadata):
            ...
            @classmethod
            def create_dataset_metadata(cls, dataset_name, root_dir, items, metadata_name=None, *, dry_run=False, saver_overwrite=None):
                pass
    ...
    def test_abstract_property_requirements(self):
        ...
        expected_properties = {
            ...
            'context', 'license', 'creators', 'hash_sha256'
        }
